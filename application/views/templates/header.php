			...
			<ul class="navbar-nav navbar-right">
				...
				<li class="dropdown"><a href="#" data-toggle="dropdown"
					...
					<div class="dropdown-menu dropdown-menu-right pullDown">
						<div class="dropdown-title"><?= $this->session->userdata('user_level'); ?></div>
			...
			<aside id="sidebar-wrapper">
				...
				<div class="sidebar-user">
					...
					<div class="sidebar-user-details">
						<div class="user-name"><?= $this->session->userdata('user_username'); ?></div>
						<div class="user-role"><?= $this->session->userdata('user_level'); ?></div>
					</div>
				</div>
				<ul class="sidebar-menu">
					...
					?> "><a href="<?php echo base_url('akun') ?>"><i
								data-feather="user"></i><span>Akun</span>
						</a>
					</li>
